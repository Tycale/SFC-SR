...
try:
    ...
    comp5.sendline('cd /root/srmthesis/services/compression/')
    comp5.prompt(timeout=30)
    print(comp5.before)


    comp5.sendline('pkill memlink_test; ip -6 sr action flush && bash -c \'taskset -c {} ./compression --threads {} --memory 128 --type {} -{} fc01::5\' 2>&1'.format(dic[th], th, mode, comp))
    ...
    comp6.sendline('pkill iperf3; iperf3 -B fc01::6 -c fc00::44 -t 60 -F /mnt/ramfs/coucou >> /mnt/ramfs/bench_compress_t{}_{}_{} 2>&1'.format(th, mode, comp))
