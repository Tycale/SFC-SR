...
try:
    ...
    comp5.sendline('pkill memlink_test; ip -6 sr action flush && bash -c \'taskset -c {} ./memlink_test --threads {} --memory 128 --mode {} fc01::5\' 2>&1'.format(dic[th], th, mode))
    ...
    comp6.sendline('pkill iperf3; iperf3 -B fc01::6 -c fc00::44 -t 60 -F /mnt/ramfs/coucou >> /mnt/ramfs/bench_memlink_{}_th{} 2>&1'.format(mode, th))
